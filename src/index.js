...
document.addEventListener("DOMContentLoaded", function () {
  botonReset.addEventListener("click", function () {
    ...
    listelement[2].innerHTML =
      "Recuento de caracteres sin espacios ni signos: 0";
    listelement[3].innerHTML = "Longitud media de las palabras: 0";
...
userinput.addEventListener("keyup", leerdatos);
...
function leerdatos() {
  ...
  const sinespacios = analyzer.getCharacterCountExcludingSpaces(
    userinput.value
  );
  listelement[2].textContent =
    "Recuento de caracteres sin espacios ni signos: " + sinespacios;
